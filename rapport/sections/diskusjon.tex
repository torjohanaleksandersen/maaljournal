...
\subsection{Måling på RC-ledd 1}
\subsubsection{Én kondensator}
Kretsen under viser målingsutgangspunktet i resultatet~\ref{subsec:rc-ledd-1_resultat}

\begin{figure}[H]
\centering
\begin{circuitikz}[american voltages]

    \node[circle, fill=black, inner sep=0pt] (A)  at (0,0) {};
    \node[circle, fill=black, inner sep=0pt] (B)  at (0,4) {};
    \node[circle, fill=black, inner sep=0pt] (C)  at (8,4) {};
    \node[circle, fill=black, inner sep=0pt] (D)  at (8,0) {};
...
\noindent
Dette betyr at siden totalkapasitansen er lavere vil da tidskonstanten også være lavere, kondensatoren vil ha en lavere oppladings- og utladingstid. Resultatet viser akkurat dette sammenliknet med bare én kondensator, siden tidskonstanten er lavere vil endringen i spenning være raskere.
...
\begin{circuitikz}[american voltages]
    ...
    \node[circle, fill=black, inner sep=0pt] (DR)  at (8,0) {};
...
\noindent
Denne totalkapasitanten forteller oss at tidskonstanten vil være høyere enn hva den vil være hvis det var én kondensator alene. Derfor vil kondensatorene her lades og utlades med lavere hastighet enn ved seriekoblede kondensatorer. Derfor vil dette resultatet være et bra bilde.
...
For å sammenlikne tilfellene må vi diskutere hvorfor grafene stiger og synker på forskjellige hastigheter fra hverandre. Resultatene er gode bilder av hvordan spenningen over kondensatorer utgjør seg i praksis i tilfellene våre; én kondensator, seriekoblet og parallellkoblet kondensatorer. Ser vi på formelen for opplading og nedlading i spenning for kondensatorer ser vi at det bestemmes av hva \emph{Euler's konstant} er opphøyd til. Det bestemmes derfor bare av tidskonstanten, \emph{tau}. Tidskonstanten er regnet ut som $\tau = R\cdot C_{tot}$. Siden motstanden er konstant vil tidskonstanten være lineær med den totale kapasitansen over området.
\\[1em]
Totalkapasitansen vil være forskjellig i hvert tilfelle. Siden vi har like kapasitanser på $C = 470\text{nF}$, vil da hvert tilfelle gi kapasitansene:
...
\noindent
Disse ulike verdiene forteller oss at parallellkoblede kondensatorer vil bruke lengre tid på å lade opp, men også lengre tid på å lade ut. Tilfellet for seriekoblede vil være motsatt. Det er akkurat dette resultatet viser og det samsvarer godt med teorien i graf~\ref{fig:teoretisk_tilfellene_1til3}.
...
Kretsen for målingen av spole induktans er som i kretsen i figur~\ref{fig:rl-ledd}. 
